...
%
user_ID=1;
e4_path_file=sprintf('/Users/deborasalgado/Desktop/Simulator Datasets/Simulator_Analysis_2023/dataset/%d/E4/e4/',user_ID);
%cd(e4_path_file);
...
% ----------------------
 EDA_Features = extractSCR                      metrics(EDA_timetable);
