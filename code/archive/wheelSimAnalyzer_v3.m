        ...
        if isfield(participantData, 'tags_csv')
            ...
            if ~isempty(tags_timetable) && width(tags_timetable) >= 4
             ...
             if ~isempty(HR_timetable)
                ...
                % Convert extracted features to structures
...
% Create a function to align columns in a table
...
%Merte Physiological(only difference), Questionnaire and System data
